...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    icons: {
      icon: [
        { url: "/gdc-browser-icon-v5.png", type: "image/png", sizes: "64x64" },
        { url: "/gdc-browser-icon-v5.ico", type: "image/x-icon", sizes: "16x16 32x32 48x48" },
      ],
      shortcut: "/gdc-browser-icon-v5.png",
